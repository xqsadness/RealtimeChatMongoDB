...
class CONSTANT{
    ...
    func load(_ completion: @escaping (()->Void)){
        if CONSTANT.USING_MANIFEST && Network.connectedToNetwork(){
            ...
            //Comment all code bellow if don't use temp_manifest
            //All Value constant must set to defualt value
...
extension CONSTANT{
    ...
    static var TIME_INSTALLED_APP = "TIME_INSTALLED_APP"
    static var SAVE_VERSION_APP = "SAVE_VERSION_APP"
}
